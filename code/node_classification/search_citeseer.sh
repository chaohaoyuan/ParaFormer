...
for DATASET in citeseer-gcn-search
do
    ...
    do
        ...
        do
            ...
            do
                ...
                python main.py --backbone gcn --dataset citeseer --lr ${LR} --num_layers 2 \
                --hidden_channels ${dim} --weight_decay 0.01 --dropout 0.5 \
                --method GPR --ours_layers 1 --graph_weight 0.5 --use_graph\
                --ours_dropout ${dropout} --use_residual --alpha 0.5 --ours_weight_decay 0.01 \
                --rand_split --train_prop 0.6 --valid_prop 0.2 --no_feat_norm \
                --seed 123 --device 4 --runs 5 --init_alpha 0.1 >> results/${DATASET}.txt
            done
        done
    done
done